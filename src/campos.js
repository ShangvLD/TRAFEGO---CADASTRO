...
const CAMPOS_TERCEIRO = [
  {
    ...
    icone: 'person',
    campos: [
      { id: 'condutor_nome', escopo: 'motorista', rotulo: 'Condutor', tipo: 'nome', obrigatorio: true, largura: 'larga',
        placeholder: 'Nome completo do condutor', sistema: true },
      { id: 'condutor_cpf', escopo: 'motorista', rotulo: 'CPF', tipo: 'cpf', obrigatorio: true,
        placeholder: '000.000.000-00', dica: 'Conferido pelo dígito verificador', sistema: true },
      { id: 'condutor_telefone', escopo: 'motorista', rotulo: 'Contato Motorista:', tipo: 'telefone', obrigatorio: true,
        placeholder: '(47) 98869-7821' },
      { id: 'condutor_email', escopo: 'motorista', rotulo: 'EMAIL', tipo: 'email', obrigatorio: false, largura: 'larga',
  ...
  },
  {
    ...
    icone: 'badge',
    campos: [
      { id: 'cnh_numero', escopo: 'motorista', rotulo: 'Número da CNH', tipo: 'texto', obrigatorio: false, max: 14,
        placeholder: '11 dígitos' },
      { id: 'cnh_categoria', escopo: 'motorista', rotulo: 'Categoria', tipo: 'selecao', obrigatorio: false,
        opcoes: ['A', 'B', 'C', 'D', 'E', 'AB', 'AC', 'AD', 'AE'] },
      { id: 'cnh_validade', escopo: 'motorista', rotulo: 'Validade', tipo: 'data', obrigatorio: false },
    ],
  },
  {
  ...
  },
  {
    ...
    icone: 'local_shipping',
    campos: [
      { id: 'placa_cavalo', escopo: 'veiculo', rotulo: 'Placa Cavalo', tipo: 'placa', obrigatorio: false,
        placeholder: 'ABC1D23', sistema: true },
      { id: 'placa_carreta', escopo: 'carreta', rotulo: 'Placa Carreta', tipo: 'placa', obrigatorio: false,
  ...
  },
  {
    ...
    icone: 'my_location',
    campos: [
      { id: 'tag', escopo: 'veiculo', rotulo: 'TAG de pedágio', tipo: 'selecao', obrigatorio: false,
        opcoes: ['CONECT CAR', 'SEM PARAR', 'VELOE'] },
      { id: 'rastreador', escopo: 'veiculo', rotulo: 'Rastreador', tipo: 'selecao', obrigatorio: false,
        opcoes: ['SASCAR', 'AUTOTRAC', 'ONIXSAT', 'OMNILINK'] },
      { id: 'rastreador_id', escopo: 'veiculo', rotulo: 'Rastreador ID', tipo: 'texto', obrigatorio: false, max: 60,
